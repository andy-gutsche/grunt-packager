 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-boxshadow-multiplebgs-opacity-cssanimations-csscolumns-cssgradients-csstransforms-csstransforms3d-csstransitions-canvas-audio-video-input-inputtypes-localstorage-sessionstorage-geolocation-inlinesvg-touch-mq-cssclasses-addtest-prefixed-teststyles-testprop-testallprops-prefixes-domprefixes-css_boxsizing-css_cubicbezierrange-css_displaytable-css_mediaqueries-elem_track
 */
;
...
Modernizr.addTest('mediaqueries', Modernizr.mq('only all'));// cubic-bezier values can't be > 1 for Webkit until bug #45761 (https://bugs.webkit.org/show_bug.cgi?id=45761) is fixed
// By @calvein
